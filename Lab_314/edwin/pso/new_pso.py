...
def fitnessFunction(ls_months,ls_Vn_n):
    ...
    for k in range(24):
        for m in range(len(ls_months.append(24))):
            if k >= ls_months[m]:
                continue
            else:
                if ((totalflow[k]['A'] is not 0) and (maxtotalflow[k]['A'] is not 0)) :
                    #基本電費
                    basic1 = ( 217.3 * ls_Vn_n[m][0] + 160.6 * ls_Vn_n[m][1] + 43.4 * ls_Vn_n[m][2] * max(( ls_Vn_n[m][2] + ls_Vn_n[m][3] - 0.5 * ( ls_Vn_n[m][0] + ls_Vn_n[m][1] )),0) ) * 0.98 * 1.15 #夏月
                    #流動電費
                    ...
                    overAprice1 = 2 * 217.3 * max(min(Eovc1_1, (0.1*ls_Vn_n[m][0])), 0) + 3*217.3*max((Eovc1_1-(0.1*ls_Vn_n[m][0])), 0)  #夏月
                    overBprice1 = 2*160.6*max(min(Eovc1_2,(0.1*ls_Vn_n[m][1])),0) + 3*160.6*max((Eovc1_2-(0.1*ls_Vn_n[m][1])),0)
                    overDprice1 = 2*43.3*max(min(Eovc1_4,(0.1*ls_Vn_n[m][3])),0) + 3*43.3*max((Eovc1_4-(0.1*ls_Vn_n[m][3])),0)
                    overCprice1 = 2*43.3*max(min(Eovc1_3,(0.1*ls_Vn_n[m][2])),0) + 3*43.3*max((Eovc1_3-(0.1*ls_Vn_n[m][2])),0)
                    ...
                    #基本電費
                    basic1 = ( 160.6 * ls_Vn_n[m][0] + 160.6 * ls_Vn_n[m][1] + 32.1 * ls_Vn_n[m][2] * max(( ls_Vn_n[m][2] + ls_Vn_n[m][3] - 0.5 * ( ls_Vn_n[m][0] + ls_Vn_n[m][1] )),0) ) * 0.98 * 1.15 #非夏月
                    #流動電費
                    ...
                    overAprice1 = 2*160.6*max(min(Eovc1_1,(0.1*ls_Vn_n[m][0])),0) + 3*160.6*max((Eovc1_1-(0.1*ls_Vn_n[m][0])),0)
                    overBprice1 = 2*160.6*max(min(Eovc1_2,(0.1*ls_Vn_n[m][1])),0) + 3*160.6*max((Eovc1_2-(0.1*ls_Vn_n[m][1])),0) #非夏月
                    overDprice1 = 2*43.3*max(min(Eovc1_4,(0.1*ls_Vn_n[m][3])),0) + 3*43.3*max((Eovc1_4-(0.1*ls_Vn_n[m][3])),0)
                    overCprice1 = 2*43.3*max(min(Eovc1_3,(0.1*ls_Vn_n[m][2])),0) + 3*43.3*max((Eovc1_3-(0.1*ls_Vn_n[m][2])),0)
                    overprice1 = overAprice1 + overBprice1 + overDprice1 + overCprice1
                    #price1 = basic1 + flowsummer1 + discount1 + overprice1
