...
maleSpeech, _, Fs = read_wave("cock_tailk_python\Ted\man1_train.wav")
femaleSpeech, _, _ = read_wave("cock_tailk_python\Ted\man2_train.wav")
...
sf.write(r"cock_tailk_python\noice_audio.wav", mixTrain, Fs)
