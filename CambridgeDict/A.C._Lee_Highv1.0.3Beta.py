...
if __name__ == "__main__":
    ...
    # print("Press 'Ctrl + q' to activate the translater. ")
    context = str()
    windowindex = 0
    Word = ""
    ...
    while True:
        ...
        x_position = win_width - axis_x
        y_position = win_height - axis_y

        # window.resizable(True, True)
        if (y_position -1 < 617) and (x_position -1 < 617):
            window.geometry('617x617+'+ str(axis_x - 617 - 51) +'+'+ str(axis_y - 617 - 51))
        elif (x_position -1) < 617:
            window.geometry('617x617+'+ str(axis_x - 617 - 51) +'+'+ str(axis_y + 1))
        elif (y_position -1) < 617:
            window.geometry('617x617+'+ str(axis_x + 1) +'+'+ str(axis_y - 617 - 51))
        else:
            window.geometry('617x617+'+ str(axis_x + 1) +'+'+ str(axis_y + 1))
        ...
        listbox.bind("<Double-Button-1>", press)
