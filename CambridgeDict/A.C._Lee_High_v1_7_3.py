                            ...
                            if POS is not None:
                                ...
                                for index, search_result in enumerate(search_results):
                                    ...
                                    if language == 'C' or language == 'c':
                                        chi = search_result.find('span', {'class':'trans dtrans dtrans-se break-cj'})
                                        context += '\n ' + str(chi.get_text()) + '\n'
                                        # print('', chi.get_text(), '\n')
                                    else:
                                        pass
...
# Export to exe: pyinstaller -F ./CambridgeDict/A.C._Lee_High_v1_7_3.py -i ./CambridgeDict/Icon_0-removebg-preview.ico 

# v1_7_3 Update: 
# Some tags of Cambridge webpage are changed.